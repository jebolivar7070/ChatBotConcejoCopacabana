            ...
            for event in entry['messaging']:
                if event.get('message', None):
                    ...
                    if any([re.match(w, text.lower()) for w in start_words]):
                        send_message(sender_id, "Hola. Soy un bot \U0001F916 programado para asesorarte,bienvenido al chat del Concejo Municipal de Copacabana. ¿En qué te puedo ayudar?")
                        if len(text_words) > 1:
